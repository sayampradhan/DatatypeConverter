...
def int_to_str():
    user_input = int(input("Write an integer to convert: "))
...
def float_to_str():
    user_input = float(input("Write a float to convert: "))
...
def list_to_tuple():
    ...
    new_tuple = ()
    no_of_elements = int(
        input("Write the number of elements you want to add to your list: ")
    )

    for i in range(no_of_elements):
        input_elements = input("Write the element: ")
...
def tuple_to_list():
    ...
    tuple = ()
    no_of_elements = int(
        input("Write the number of elements you want to add to your tuple: ")
    )
...
# user input
user_choice = int(input("Write your choice here: "))
